...
/**
 * Wire contract shared with the {@code cybercore-message-encryption} Fabric mod.
 * <p>
 ...
 * Minecraft's own codecs, because Bukkit's messenger delivers a raw {@code byte[]} and the mod
 * must be able to produce exactly these bytes from its side.
 * <p>
 * Any change to the opcodes or field order has to be mirrored in the mod's copy of this file
