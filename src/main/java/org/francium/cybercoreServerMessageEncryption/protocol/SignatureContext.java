 ...
 * <p>
 * Signer and verifier live in different code bases, so this file is duplicated verbatim from the
 * Fabric mod: if the two ever drift, every signature fails closed rather than silently
